...
function ig_theme_styles(){
  ...
  wp_enqueue_style("cleanblog", get_template_directory_uri()
  ...
  wp_enqueue_script("cleanblog_js", get_template_directory_uri()
    ."/js/clean-blog.min.js");

function ig_after_setup(){
